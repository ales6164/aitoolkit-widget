...
var _API_URL = process.env.REACT_APP_API_URI || "https://chat-gpt-374521.oa.r.appspot.com/v1";
var _STREAMING_API_URI = process.env.REACT_APP_STREAMING_API_URI || "https://api2.aitoolkit.dev/v1";
var ROLE = {
    SYSTEM: "system",
    USER: "user",
    ASSISTANT: "assistant"
...
function useBot() {
    ...
    var API_URL = config.apiUrl || _API_URL;
    var STREAMING_API_URI = config.streamingApiUri || _STREAMING_API_URI;
