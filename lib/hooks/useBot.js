...
function useBot() {
    ...
    var _useState = (0, _react.useState)(config.chatId),
    ...
    (0, _react.useEffect)(function () {
        ...
        if (botId) {
            ...
            if (config.enableLocalStorage && (_window = window) !== null && _window !== void 0 && (_window$localStorage = _window.localStorage) !== null && _window$localStorage !== void 0 && _window$localStorage.getItem) {
                var stored = JSON.parse(window.localStorage.getItem("bot-".concat(config.id)));

                //console.log(config.enableLocalStorage, stored)

                if ((stored === null || stored === void 0 ? void 0 : stored.timestamp) > Date.now() - 1000 * 60 * 60 * 24) {
                    if ((stored === null || stored === void 0 ? void 0 : stored.chatId) === chatId || !chatId) {
                        if (stored !== null && stored !== void 0 && stored.chatId) chatId = stored.chatId;
                        if (stored !== null && stored !== void 0 && stored.messages) messages = stored === null || stored === void 0 ? void 0 : stored.messages.map(function (m) {
            ...
            fetch("".concat(API_URL, "/bots/").concat(botId), {
                ...
                if (botId === config.id) {
                    ...
                    if (config.chatId === chatId && chatId) {
                        return fetch("".concat(API_URL, "/bots/").concat(botId, "/chat/").concat(chatId), {
                            headers: config.headers
                        }).then( /*#__PURE__*/function () {
    ...
    (0, _react.useEffect)(function () {
        ...
        if (config.enableLocalStorage && (_window2 = window) !== null && _window2 !== void 0 && (_window2$localStorage = _window2.localStorage) !== null && _window2$localStorage !== void 0 && _window2$localStorage.setItem && (data === null || data === void 0 ? void 0 : data.id) === config.id && messages !== null && messages !== void 0 && messages.length) {
    ...
    function _sendMessage() {
        _sendMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(chatMessage) {
                                ...
                                return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                                    while (1) switch (_context3.prev = _context3.next) {
                                        case 0:
                                            ...
                                            _context3.t1 = _objectSpread({}, res);
                                            _context3.t2 = {};
                                            _context3.next = 5;
                                            return res.json();
                                        case 5:
    ...
    function resetConversation() {
        ...
        if (config.enableLocalStorage && (_window3 = window) !== null && _window3 !== void 0 && (_window3$localStorage = _window3.localStorage) !== null && _window3$localStorage !== void 0 && _window3$localStorage.setItem && (data === null || data === void 0 ? void 0 : data.id) === config.id) {
            window.localStorage.setItem("bot-".concat(config.id), JSON.stringify({
                id: config.id,
                chatId: chatId,
                messages: [],
